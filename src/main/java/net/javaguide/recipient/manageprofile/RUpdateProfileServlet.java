package net.javaguide.recipient.manageprofile;
 ...
 */
@WebServlet("/RUpdateProfileServlet")
public class RUpdateProfileServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RUpdateProfileServlet() {
        super();
        ...
        try {
            ...
            PreparedStatement stmt = conn.prepareStatement(
                "UPDATE user SET name = ?, phone = ?, address = ?, city = ?, gender = ?, dob = ?, blood_group=? Where email= ?"
                    ...
                    RequestDispatcher dispatcher = request.getRequestDispatcher("rmanageProfile.jsp");
